...
class OptionLinkTest extends TestCase
{
    public function testThatOptionGroupsAreTheSame()
    {
        ...
        $contextualOption1 = ContextualOptionsService::constructOption($optionGroup1, $context1, 'g1_co1_c1', 'g1_co1_c1');
        $contextualOption2 = ContextualOptionsService::constructOption($optionGroup1, $context2, 'g1_co2_c2', 'g1_co2_c2');
//        $contextualOption3 = ContextualOptionsService::constructOption($optionGroup1, $context1, 'g1_co3_c1', 'g1_co3_c1');
        $contextualOption3 = ContextualOptionsService::constructOption($optionGroup2, $context1, 'g2_co4_c1', 'g2_co4_c1');

        $optionLink = ContextualOptionsService::constructOptionLink($contextualOption1, $contextualOption2);

        $this->expectException(UnequalOptionGroupException::class);
        $optionLink = ContextualOptionsService::constructOptionLink($contextualOption1, $contextualOption3);
    }
}